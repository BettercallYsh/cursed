...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7196QO7OSdNWbaM")
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002106428894")) #Your db channel Id
OWNER = os.environ.get("OWNER", "ap") # Owner username without @
...
DB_NAME = os.environ.get("DATABASE_NAME", "monkepostingbot")
#--------------------------------------------
...
USER_REPLY_TEXT = "you are not my owner"
#--------------------------------------------
